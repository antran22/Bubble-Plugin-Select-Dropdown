function(instance, context) {
    ...
    instance.data.injectTimer = null;
    ...
    function tryInject(retryLeft, properties) {
        ...
        if (!element._vdom) {
            if (instance.data.injectTimer) {
                clearTimeout(instance.data.injectTimer);
            }
            instance.data.injectTimer = setTimeout(() => tryInject(retryLeft - 1, properties), 200);
            return;
        }
